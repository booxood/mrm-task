const { json, yaml, packageJson, lines, install, uninstall, getExtsFromCommand } = require('mrm-core')
...
function task (config) {
  ...
  let eslintrc = yaml('.eslintrc.yml')
  let eslintrcJson = json('.eslintrc')
  if (eslintrcJson.exists()) {
    eslintrc.merge(eslintrcJson.get())
  }
